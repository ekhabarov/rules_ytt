...
#
# These can be registered in the workspace file or passed to
# --extra_toolchains flag. By default all these toolchains are registered by
# the rules_ytt_register_toolchains macro so you don't normally need to
...
toolchain(
    ...
    toolchain = "@{ytt}_{platform}//:ytt_toolchain",
    toolchain_type = "@rules_ytt//ytt:toolchain_type",
)
""".format(
            platform = platform,
            name = rctx.attr.name,
...
toolchains_repo = repository_rule(
    ...
    attrs = {
        "ytt": attr.string(doc = "what the user chose for the base name"),
    },
)
